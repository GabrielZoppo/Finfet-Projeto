...
.measure TRAN pd_lh_b1 TRIG v(b) VAL=0.385 RISE=1 TARG v(s) VAL=0.385 RISE=1
.measure TRAN pd_hl_b1 TRIG v(b) VAL=0.385 FALL=1 TARG v(s) VAL=0.385 FALL=1

.measure TRAN pd_lh_a1 TRIG v(a) VAL=0.385 RISE=1 TARG v(s) VAL=0.385 RISE=2
.measure TRAN pd_hl_a1 TRIG v(a) VAL=0.385 FALL=1 TARG v(s) VAL=0.385 FALL=2

.measure TRAN pd_lh_c1 TRIG v(c) VAL=0.385 RISE=1 TARG v(s) VAL=0.385 RISE=3
.measure TRAN pd_hl_c1 TRIG v(c) VAL=0.385 FALL=2 TARG v(s) VAL=0.385 FALL=3

.measure TRAN pd_hl_a2 TRIG v(a) VAL=0.385 RISE=2 TARG v(s) VAL=0.385 RISE=4
.measure TRAN pd_lh_a2 TRIG v(a) VAL=0.385 FALL=2 TARG v(s) VAL=0.385 FALL=4

.measure TRAN pd_hl_c2 TRIG v(c) VAL=0.385 RISE=2 TARG v(s) VAL=0.385 RISE=5
.measure TRAN pd_lh_c2 TRIG v(c) VAL=0.385 FALL=3 TARG v(s) VAL=0.385 FALL=5

.measure TRAN pd_hl_b2 TRIG v(b) VAL=0.385 RISE=3 TARG v(s) VAL=0.385 RISE=6
.measure TRAN pd_lh_b2 TRIG v(b) VAL=0.385 FALL=3 TARG v(s) VAL=0.385 FALL=6
