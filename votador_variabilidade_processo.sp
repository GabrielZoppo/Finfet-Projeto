** Votador Majoritario Com Mux - Variabilidade do Processo
...
* Inserção de variabilidade de processo
statistics
{
	process	
	{
...
* Declaração das ondas de entrada (CARACTERIZAÇÃO)
...
.measure TRAN pd_lh_a2 TRIG v(a) VAL=0.35 RISE=2 TARG v(s) VAL=0.35 RISE=4
.measure TRAN pd_hl_a2 TRIG v(a) VAL=0.35 FALL=2 TARG v(s) VAL=0.35 FALL=4

.measure TRAN pd_lh_c2 TRIG v(c) VAL=0.35 RISE=2 TARG v(s) VAL=0.35 RISE=5
.measure TRAN pd_hl_c2 TRIG v(c) VAL=0.35 FALL=3 TARG v(s) VAL=0.35 FALL=5

.measure TRAN pd_lh_b2 TRIG v(b) VAL=0.35 RISE=3 TARG v(s) VAL=0.35 RISE=6
.measure TRAN pd_hl_b2 TRIG v(b) VAL=0.35 FALL=3 TARG v(s) VAL=0.35 FALL=6
